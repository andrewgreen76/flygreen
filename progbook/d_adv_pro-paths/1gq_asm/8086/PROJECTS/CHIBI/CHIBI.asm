	...
	call ShowSprite		; Show AT starting position (SPRITE ORIGIN). 
...
; Draw XOR sprite. 
	mov si, offset BitmapTest			; DS:SI - source bitmap / Point SI to bitmap code. 
	mov cl, 8							; cl = height. 
